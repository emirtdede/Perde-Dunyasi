      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-12 sm:grid-cols-2 sm:px-10 lg:grid-cols-3 lg:px-12 items-start">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2.5 text-sm text-[var(--muted)]">
            <p className="flex items-center gap-2"><span>📍</span> Adıyaman, Türkiye</p>
            <p className="flex items-center gap-2"><span>📞</span> 0555 123 45 67</p>
            <p className="flex items-center gap-2"><span>✉️</span> info@perdedunyasi.com</p>
          </div>
          <a
