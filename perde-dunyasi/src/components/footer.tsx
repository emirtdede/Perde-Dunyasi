...
const dict = {
  tr: {
    brandName: "Perde Dünyası",
    brandDesc: "Perde, tül, stor ve jaluzi ürünlerinde kaliteli çözümler.",
    whatsappHelp: "WhatsApp üzerinden hızlıca fiyat teklifi alabilir, mağazamızı ziyaret edebilirsiniz.",
    quickLinks: "Hızlı Linkler",
    contact: "İletişim",
    whatsappBtn: "WhatsApp ile İletişim",
    mapTitle: "Mağaza Konumu",
    mapIframeTitle: "Perde Dünyası Harita Konumu",
  ...
  en: {
    brandName: "Perde Dünyası",
    brandDesc: "Quality solutions in curtains, tulle, roller blinds and venetian blinds.",
    whatsappHelp: "Get a price quote quickly on WhatsApp, or feel free to visit our store.",
    quickLinks: "Quick Links",
    contact: "Contact",
    whatsappBtn: "Contact via WhatsApp",
    mapTitle: "Store Location",
    mapIframeTitle: "Perde Dünyası Store Location Map",
    rightsReserved: "All rights reserved.",
    adminPanel: "Admin Panel",
    links: [
      { href: "/katalog", label: "Product Catalog" },
      { href: "/urunler", label: "All Products" },
...
export function Footer({ lang = "tr", settings }: FooterProps) {
  ...
  let mapSrc = settings?.google_maps_url || defaultTrMap;
  if (activeLang === "en" && mapSrc) {
    mapSrc = mapSrc.replace("3m2!1str!2str", "3m2!1sen!2str");
  }
    ...
    <footer className="border-t border-[var(--card-border)] bg-[var(--background)]">
      ...
      <div className="border-t border-[var(--card-border)]">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-2 px-6 py-4 text-xs text-[var(--muted)] sm:flex-row sm:px-10 lg:px-12">
          <p>© {currentYear} Perde Dünyası. {t.rightsReserved}</p>
